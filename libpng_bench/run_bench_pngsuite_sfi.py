...
WASM = ROOT / "build" / "sfi" / "final_sfi_libpng.wasm"
RESULT_CSV = ROOT / "bench_result" / "sfi_pngsuite_decode.csv"
...
def run_one(module, engine, png_path: Path, run_idx: int):
...
def main():
    ...
    for p in png_files:
        for i in range(RUNS):
            rows.append(run_one(module, engine, p, i))
