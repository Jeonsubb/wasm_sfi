...
#     ifndef PNG_VERSION_INFO_ONLY
         ...
         typedef png_double*           png_doublep_deprecated; /* [patched for freestanding build] */
         typedef const png_double*     png_const_doublep_deprecated; /* [patched for freestanding build] */
         typedef png_double**          png_doublepp_deprecated; /* [patched for freestanding build] */
#     endif
#  endif
#endif
