...
VARIANT = "mem1"
WASM = os.path.join(ROOT, "build", "mem1", "final_mem1.wasm")
...
def main():
    ...
    run_uncompress_bench(
        fresh_funcs,
        os.path.join(RESULT_DIR, "mem1_compress.csv"),
        os.path.join(RESULT_DIR, "mem1_uncompress.csv"),
    )
