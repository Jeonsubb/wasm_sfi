; ModuleID = '/home/ubuntu/wasm-mem1-copy-out-remove/snappy_bench/build/mem1/mem1_rust_ffi.bc'
...
^0 = module: (path: "/home/ubuntu/wasm-mem1-copy-out-remove/snappy_bench/build/mem1/mem1_rust_ffi.bc", hash: (376038658, 671598576, 1780345277, 2616135721, 1771037013))
^1 = gv: (name: "snappy_max_compressed_length") ; guid = 1334863435944618703
^2 = gv: (name: "_ZN11rust_snappy18BENCH_UNCOMPRESSED17h5463976b7621d031E", summaries: (variable: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 1, constant: 0)))) ; guid = 1898258598247227311
^3 = gv: (name: "bench_snappy_uncompress", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 14, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 0, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), calls: ((callee: ^8, tail: 1)), refs: (^13, ^2, readonly ^6, readonly ^17)))) ; guid = 3255933891736436842
^4 = gv: (name: "_ZN11rust_snappy17BENCH_TARGET_SIZE17h35ac4feaefc47175E.0", summaries: (variable: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 1, constant: 0)))) ; guid = 4298289919406518280
^5 = gv: (name: "llvm.lifetime.start.p0") ; guid = 4736283418132453162
^6 = gv: (name: "_ZN11rust_snappy20BENCH_COMPRESSED_LEN17h9f3939e79eb2d8e4E.0", summaries: (variable: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 1, constant: 0)))) ; guid = 4841764104641535942
^7 = gv: (name: "bench_snappy_compress", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 36, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 0, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), calls: ((callee: ^20, tail: 1), (callee: ^1, tail: 1), (callee: ^24)), refs: (^21, ^11, ^13, ^9, readonly ^14, readonly ^4, writeonly ^6, writeonly ^17)))) ; guid = 5360170283557215228
^8 = gv: (name: "snappy_uncompress_with_len") ; guid = 5799550946172047720
^9 = gv: (name: "_ZN11rust_snappy16SNAPPY_ENV_READY17h78e75501de0677ffE.0", summaries: (variable: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 1, constant: 0)))) ; guid = 7746891136223797177
^10 = gv: (name: "bench_verify_uncompress", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 16, funcFlags: (readNone: 0, readOnly: 1, noRecurse: 0, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), calls: ((callee: ^18, tail: 1)), refs: (^2, ^11, readonly ^6, readonly ^17)))) ; guid = 8236978312630354369
^11 = gv: (name: "_ZN11rust_snappy12BENCH_TARGET17hae7d3ff8efd34119E", summaries: (variable: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 1, constant: 0)))) ; guid = 10499079657174128943
^12 = gv: (name: "bench_prepare", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 14, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 0, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), calls: ((callee: ^15, tail: 1)), refs: (^11, writeonly ^14, writeonly ^4, writeonly ^6, writeonly ^17)))) ; guid = 10645803963521086569
^13 = gv: (name: "_ZN11rust_snappy16BENCH_COMPRESSED17h02e255e6b4d0b1b7E", summaries: (variable: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 1, constant: 0)))) ; guid = 11761187661777702981
^14 = gv: (name: "_ZN11rust_snappy18BENCH_TARGET_READY17h50272c3ff1d65635E.0", summaries: (variable: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 1, constant: 0)))) ; guid = 11835866350886482821
^15 = gv: (name: "bench_fill_target_from_pool") ; guid = 13196600435978151043
^16 = gv: (name: "llvm.lifetime.end.p0") ; guid = 13244677477227836793
^17 = gv: (name: "_ZN11rust_snappy21BENCH_COMPRESSED_SIZE17hc0778b03ca24e4d2E.0", summaries: (variable: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 1, constant: 0)))) ; guid = 13385341733540531140
^18 = gv: (name: "memcmp") ; guid = 13767193220660627266
^19 = gv: (name: "rust_begin_unwind", summaries: (function: (module: ^0, flags: (linkage: external, visibility: hidden, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 2, funcFlags: (readNone: 1, readOnly: 0, noRecurse: 1, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0)))) ; guid = 15232728727531135878
^20 = gv: (name: "snappy_init_env_with_len") ; guid = 16655315327441271836
^21 = gv: (name: "_ZN11rust_snappy10SNAPPY_ENV17hbfdcf2c0e04c73a7E", summaries: (variable: (module: ^0, flags: (linkage: internal, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), varFlags: (readonly: 1, writeonly: 1, constant: 0)))) ; guid = 16933829372140535292
^22 = gv: (name: "bench_get_compressed_len", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 2, funcFlags: (readNone: 0, readOnly: 1, noRecurse: 1, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), refs: (readonly ^6)))) ; guid = 16984045162532658985
^23 = gv: (name: "bench_verify_compress", summaries: (function: (module: ^0, flags: (linkage: external, visibility: default, notEligibleToImport: 0, live: 0, dsoLocal: 1, canAutoHide: 0), insts: 16, funcFlags: (readNone: 0, readOnly: 0, noRecurse: 0, returnDoesNotAlias: 0, noInline: 0, alwaysInline: 0, noUnwind: 1, mayThrow: 0, hasUnknownCall: 0, mustBeUnreachable: 0), calls: ((callee: ^1, tail: 1)), refs: (^6, readonly ^17)))) ; guid = 17559337456298019996
^24 = gv: (name: "snappy_compress_with_len") ; guid = 17969955817340999450
^25 = blockcount: 0
